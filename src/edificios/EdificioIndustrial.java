...
public abstract class EdificioIndustrial extends Edificio implements GeneradorRecursos {
    ...
    public EdificioIndustrial(String nombre, double costo,
                               double consumoEnergia, double capacidadProduccion,
    ...
    public void reparar() {
        ...
        System.out.printf(
            "  🔧 [INDUSTRIAL] %s reparado (costo de mantenimiento: $%.0f). Salud: %d%%%n",
            nombre, costoMantenimiento, salud
        );
    }
    ...
    public double getCapacidadProduccion() { return capacidadProduccion; }
