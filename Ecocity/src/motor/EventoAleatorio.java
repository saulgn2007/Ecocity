...
public class EventoAleatorio implements GeneradorRecursos{

    private static final Random RANDOM = new Random();

    // Tipos de eventos disponibles
    public enum TipoEvento {
        TORMENTA_ELECTRICA ("Tormenta eléctrica", "Los generadores de energía pierden 10% de salud."),
        OLA_DE_CALOR ("Ola de calor", "Todos los edificios consumen 20% más energía."),
        TERREMOTO ("Terremoto", "Todos los edificios pierden 15% de salud."),
        EPIDEMIA ("Epidemia", "La felicidad baja -10 puntos."),
        BONANZA_ECONOMICA ("Bonificación económica:", "La ciudad recibe un subsidio de 50,000€."),
        LLUVIA_ABUNDANTE ("Lluvia abundante", "Se recargan +5,000 L de agua."),
        SIN_EVENTO ("Mes tranquilo", "No ocurre ningún evento especial.");
    ...
    public static void aplicar(TipoEvento evento, List<Edificio> edificios, GestorRecursos recursos) {
        ...
        switch (evento) {
            ...
            case OLA_DE_CALOR:
                ...
                System.out.printf("La ciudad consume %.1f MW adicionales.%n", energiaExtra);
            ...
            case BONANZA_ECONOMICA:
                ...
                recursos.registrarEvento("Bonificación económica: +50,000€ recibidos.");
                break;

            case LLUVIA_ABUNDANTE:
                recursos.agregarAgua(5_000);
                System.out.println("Las reservas de agua aumentan en 5,000 L.");
                recursos.registrarEvento("Lluvia abundante: agua repuesta.");
                break;

            case SIN_EVENTO:
                System.out.println("Los ciudadanos disfrutan de un mes en calma.");
                break;
        }
    }
